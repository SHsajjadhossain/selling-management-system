        ...
        <aside class="sidebar-wrapper" data-simplebar="true">
          ...
          <ul class="metismenu" id="menu">
            ...
            <li>
              ...
              <ul>
                <li> <a href="{{ route('product.create') }}"><i class="bi bi-circle"></i>Add Product</a>
                </li>
                <li> <a href="{{ route('product.index') }}"><i class="bi bi-circle"></i>Product List</a>
                </li>
                <li> <a href="{{ route('trash.product') }}"><i class="bi bi-circle"></i>Trash</a>
                </li>
              </ul>
              {{-- <ul>
                <li> <a href="{{ route('product.create') }}"><i class="bi bi-circle"></i>Add Product</a>
            ...
            @endif
                ...
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Selling Info</div>
                    </a>
                    <ul>
                        @if (auth::user()->role == 2)
                            <li> <a href="{{ route('selling_info.create') }}"><i class="bi bi-circle"></i>Add Selling Info</a>
                            </li>
                            <li> <a href="{{ route('selling_info.index') }}"><i class="bi bi-circle"></i>View Your Sellings</a>
                            </li>
                        @else
                            <li> <a href="{{ route('sellinginfo.adminindex') }}"><i class="bi bi-circle"></i>View Sellings</a>
                            </li>
                        @endif
                    </ul>
                </li>
