            ...
            <div class="card rounded-0 overflow-hidden shadow-none bg-white border">
                <div class="row g-0">
                    <div class="col-12 order-1 col-xl-8 d-flex align-items-center justify-content-center border-end">
                        <img src="{{ asset('dashboard/assets/images/error/auth-img-register3.png') }}"
                            class="img-fluid" alt="">
                    </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-12 ">
                                        ...
                                        <div class="ms-auto position-relative">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror radius-30 ps-5" name="name" id="inputName" value="{{ old('name') }}"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="ms-auto position-relative">
                                            ...
                                            <input type="email" class="form-control @error('email') is-invalid @enderror radius-30 ps-5" name="email" value="{{ old('email') }}"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="ms-auto position-relative">
                                            <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i
                                                    class="bi bi-lock-fill"></i></div>
                                            <input type="password" class="form-control radius-30 ps-5" name="password_confirmation"
